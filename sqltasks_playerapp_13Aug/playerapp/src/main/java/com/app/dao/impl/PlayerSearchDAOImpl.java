...
public class PlayerSearchDAOImpl  implements PlayerSearchDAO{
	...
	public List<Player> getPlayersByName(String name) throws BusinessException {
		...
		try(Connection connection=MySqlDbConnection.getConnection()){
			...
			if(playerList.size()==0) {
				throw new BusinessException("No Players for Name "+name);
			}
		} catch (ClassNotFoundException | SQLException e) {
			log.error(e);
			throw new BusinessException("Internal error occured contact sysadmin");
	...
	public List<Player> getPlayersByAge(int age) throws BusinessException {
		...
		try(Connection connection=MySqlDbConnection.getConnection()){
			...
			if(playerList.size()==0) {
				throw new BusinessException("No Players for Age "+age);
			}
		} catch (ClassNotFoundException | SQLException e) {
			log.error(e);
			throw new BusinessException("Internal error occured contact sysadmin");
	...
	public List<Player> getPlayersByCity(String city) throws BusinessException {
		...
		try(Connection connection=MySqlDbConnection.getConnection()){
			...
			if(playerList.size()==0) {
				throw new BusinessException("No Players for City "+city);
			}
		} catch (ClassNotFoundException | SQLException e) {
			log.error(e);
			throw new BusinessException("Internal error occured contact sysadmin");
	...
	public List<Player> getPlayersByGender(String gender) throws BusinessException {
		...
		try(Connection connection=MySqlDbConnection.getConnection()){
			...
			if(playerList.size()==0) {
				throw new BusinessException("No Players for Gender "+gender);
			}
		} catch (ClassNotFoundException | SQLException e) {
			log.error(e);
			throw new BusinessException("Internal error occured contact sysadmin");
